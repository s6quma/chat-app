...
グループ上で扱うグループ名、シェアをしたユーザー、レートと通貨の設定を行う<br>
![](create-group.png)<br>  

### グループルームの詳細（カナダ旅行中の4人のユーザーで作成されたグループルーム）<br>
シェアした金額を投稿すると、ユーザーの人数で割られた1人分の金額、円換算額、人数で割られた1人分の円換算額が自動で計算され、投稿時に表示される<br>
![](you-owe-me1.png)<br>

### 削除ボタンの詳細<br>
グループルームはグループ作成者のみに削除ボタンが表示され、ルームを削除することができる<br>
投稿した内容は投稿者のみに削除ボタンが表示され、投稿を削除することができる<br>
![](send-delete.png)<br>

### レシートも投稿可能<br>
金額の投稿のみではなく、レシートもグループルーム上で保管ができる<br>
![](send-reciept.png)<br>
